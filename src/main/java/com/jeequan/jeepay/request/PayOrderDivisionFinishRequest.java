...
*/
public class PayOrderDivisionFinishRequest implements JeepayRequest<PayOrderDivisionFinishResponse> {

    private String apiVersion = Jeepay.VERSION;
    private String apiUri = "api/division/finish";
    ...
    @Override
    public Class<PayOrderDivisionFinishResponse> getResponseClass() {
        return PayOrderDivisionFinishResponse.class;
    }
