...
*/
public class BalanceDivisionQueryRequest implements JeepayRequest<BalanceDivisionQueryResponse> {

    private String apiVersion = Jeepay.VERSION;
    private String apiUri = "api/division/balance/query";
    ...
    @Override
    public Class<BalanceDivisionQueryResponse> getResponseClass() {
        return BalanceDivisionQueryResponse.class;
    }
