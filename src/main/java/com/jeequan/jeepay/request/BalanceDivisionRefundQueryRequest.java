...
*/
public class BalanceDivisionRefundQueryRequest implements JeepayRequest<BalanceDivisionRefundQueryResponse> {

    private String apiVersion = Jeepay.VERSION;
    private String apiUri = "api/division/balance/refund/query";
    ...
    @Override
    public Class<BalanceDivisionRefundQueryResponse> getResponseClass() {
        return BalanceDivisionRefundQueryResponse.class;
    }
