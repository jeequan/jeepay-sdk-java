...
*/
public class BalanceDivisionRefundRequest implements JeepayRequest<BalanceDivisionRefundResponse> {

    private String apiVersion = Jeepay.VERSION;
    private String apiUri = "api/division/balance/refund";
    ...
    @Override
    public Class<BalanceDivisionRefundResponse> getResponseClass() {
        return BalanceDivisionRefundResponse.class;
    }
